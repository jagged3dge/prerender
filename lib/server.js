...
var COOKIES_ENABLED = process.env.PRERENDER__COOKIES_ENABLED || false;

var PAGE_DONE_CHECK_TIMEOUT = process.env.PRERENDER__PAGE_DONE_CHECK_TIMEOUT || 300;

var RESOURCE_DOWNLOAD_TIMEOUT = process.env.PRERENDER__RESOURCE_DOWNLOAD_TIMEOUT || 10 * 1000;

var WAIT_AFTER_LAST_REQUEST = process.env.PRERENDER__WAIT_AFTER_LAST_REQUEST || 500;

var JS_CHECK_TIMEOUT = process.env.PRERENDER__JS_CHECK_TIMEOUT || 300;

var JS_TIMEOUT = process.env.PRERENDER__JS_TIMEOUT || 10 * 1000;

var NO_JS_EXECUTION_TIMEOUT = process.env.PRERENDER__NO_JS_EXECUTION_TIMEOUT || 3000;

var EVALUATE_JAVASCRIPT_CHECK_TIMEOUT = process.env.PRERENDER__EVALUATE_JAVASCRIPT_CHECK_TIMEOUT || 300;

var NUM_ITERATIONS = process.env.PRERENDER__NUM_ITERATIONS || 40;
...
server._send = function(req, res, statusCode, options) {
    ...
    this._pluginEvent("beforeSend", [req, res], function() {
        ...
        if (req.prerender.redirectURL && !(_this.options.followRedirect || process.env.PRERENDER__FOLLOW_REDIRECT)) {
